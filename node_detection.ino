...
const int en_a=6, en_b=5, a=1,b=2,c=3,d=4;
...
void loop()
{
 ...
 /*
  ...
  //Serl.println(position); // comment this line out if you are using raw values
  */
  delay(250);
  
   if(central_black==1||white_space==1)
   {
    if (sensorValues[1]>500 && sensorValues[6]>500 && sensorValues[3]<300 && sensorValues[4]<300) //line before any node
      {
  ...
  if (sensorValues[3]>500 && sensorValues[4]>500) // central black line
    {
     central_black=1;
    }
